		...
		<div className="flex flex-row justify-center items-center min-w-full border-black border-b-[1px] mb-1.5 bg-emerald-500 pt-1.5">
			{!isAuthenticated ? (
				<>
					<button
						type="button"
						className="text-white bg-[#EA4335] hover:bg-[#EA4335]/90 focus:outline-none font-medium rounded-lg text-sm p-1.5 m-px text-center inline-flex items-center mb-2"
						onClick={() => auth('google')}
					>
						<svg
					...
					<button
						type="button"
						className="text-white bg-[#24292F] focus:outline-none font-medium rounded-lg text-sm p-1.5 text-center m-px inline-flex items-center dark:hover:bg-[#050708] mb-2"
						onClick={() => auth('github')}
					>
						<svg
							className="w-4 h-4 m-0.5"
